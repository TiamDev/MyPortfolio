...
import Work8 from "../../assets/projects/Cover_8.svg";
import Pic8 from "../../assets/projects/pic8.png";
...
const Menu = [
  {
    ...
    button:<div>
            <a href="https://github.com/TiamDev/bootcamp-final-project-Maqar-platform" className="work__button work__button-github" title="View Code">
  ...
  },
  {
    ...
    button:<div >
            <a href="https://github.com/TiamDev/mini_project_four_seasons" className="work__button work__button-github" title="View Code">
              <i className="fa-brands fa-github work__button-icon"></i>
            </a> 
            {/* <a href="#" className="work__button" title="View Website">
              <i className="icon-link work__button-icon"></i>
    ...
    category: "Web"
  },
      {
        ...
        button:<div >
                <a href="https://github.com/TiamDev/Mostaql_clone" className="work__button work__button-github" title="View Code">
                  <i className="fa-brands fa-github work__button-icon"></i>
                </a> 
                <a href="https://tiamdev.github.io/Mostaql_clone/" className="work__button" title="View Website">
                  <i className="icon-link work__button-icon"></i>
                </a>
              </div>,
        category: "Web"
      },
      {
        ...
        button:<div >
                <a href="https://github.com/TiamDev/foodi" className="work__button work__button-github" title="View Code">
                  <i className="fa-brands fa-github work__button-icon"></i>
                </a> 
                <a href="https://tiamdev.github.io/foodi" className="work__button" title="View Website">
                  <i className="icon-link work__button-icon"></i>
                </a>
              </div>,
        category: "Web"
  ...
  },
  {
      ...
      button:<div >
              <a href="https://github.com/TiamDev/DoTask" className="work__button work__button-github" title="View Code">
                <i className="fa-brands fa-github work__button-icon"></i>
              </a> 
              <a href="https://tiamdev.github.io/DoTask/" className="work__button" title="View Website">
                <i className="icon-link work__button-icon"></i>
              </a>
            </div>,
      category: "Web"
  },
  {
    ...
    button:<div >
                 <a href="https://github.com/TiamDev/MyPortfolio" className="work__button work__button-github" title="View Code">
                  <i className="fa-brands fa-github work__button-icon"></i>
                </a> 
                {/*
                <a href="https://github.com/TiamDev/sonrisa" className="work__button" title="View Website">
